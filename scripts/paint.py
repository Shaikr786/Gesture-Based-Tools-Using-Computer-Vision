...
# re = cv2.imread('re.png')
# buck = cv2.imread('buck.jpg')
# none = cv2.imread('none.png')
# undo = cv2.imread('undo.png')
...
# Load and resize tool images
circ = load_image('circle.png')
line = load_image('line.png')
re = load_image('re.png')
buck = load_image('buck.jpg')
none = load_image('none.png')
undo = load_image('undo.png')
pen = load_image("pen.png")
def run_painter():
# Display tools icons
    global selected_color, selected_tool, last_click_time, msg, fill_mode,circle_data,line_data,re_data
